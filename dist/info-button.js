(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.InfoButton = factory(global.Clappr));
  ...
  var InfoButton = /*#__PURE__*/function (_UIContainerPlugin) {
    ...
    _createClass(InfoButton, [{
      ...
      value: function bindEvents() {
        this.listenTo(this.container, core.Events.CONTAINER_OPTIONS_CHANGE, this.reload);
        this.listenTo(this.container, core.Events.CONTAINER_MEDIACONTROL_SHOW, this.render);
        this.listenTo(this.container, core.Events.CONTAINER_MEDIACONTROL_HIDE, this.hideInfoButtonMenu);
      }
    }, {
      key: "reload",
      ...
      value: function render() {
        ...
        if (this.visible === true) {
          core.$('.media-control-right-panel').append(this.$el);
        } else {
      ...
      value: function language() {
        return this.options.language || core.Utils.getBrowserLanguage();
      }
    }, {
